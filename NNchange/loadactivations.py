...
def load_nilmtk_activations(appliances, filename, sample_period, windows, min_off_duration=None, min_on_duration=None,on_power_threshold=None):
    """
    Parameters
    ----------
        ...
        for building_i, window in buildings_and_windows.iteritems():
            ...
            for appliance in appliances:
                ...
                meter_activations = meter.get_activations(
                    sample_period=sample_period,min_off_duration=min_off_duration, min_on_duration=min_on_duration,on_power_threshold=on_power_threshold)
